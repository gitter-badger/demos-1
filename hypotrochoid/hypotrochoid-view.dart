...
@CustomTag('hypotrochoid-view')
class HypotrochoidViewElement extends PolymerElement {
  ...
  HypotrochoidView view = null;

  HypotrochoidViewElement.created() : super.created() {
    ...
    this.view = new HypotrochoidView(WIDTH, HEIGHT);
...
class HypotrochoidView extends DisplayObjectContainer {
  int R = 100;
  int r = 60;
  int d = 100;
  ...
  HypotrochoidView(this.WIDTH, this.HEIGHT) {
    reset();
